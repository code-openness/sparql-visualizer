...
// TODO add EventListener for customization
// TODO call serializer on change

// Dummy Serializer for now
function init(): void {
    const datas = document.querySelectorAll('[data-visualisation]');
    console.log(datas);
    ...
    datas.forEach(function(data) {
        ...
        // TODO Call functions to create src link
        data.setAttribute('class', 'resp-container');
